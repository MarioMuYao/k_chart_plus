...
class DepthChartPainter extends CustomPainter {
  ...
  void drawText(Canvas canvas) {
    ...
    var leftHalfText = ((mBuyData!.first.price + centerPrice) / 2).toStringAsFixed(quoteUnit);
    ...
    var rightHalfText = ((mSellData!.last.price + centerPrice) / 2).toStringAsFixed(quoteUnit);
  ...
  void drawSelectView(Canvas canvas, int index, bool isLeft) {
    ...
    if (dx < mDrawWidth) {
      canvas.drawCircle(Offset(dx, dy), radius / 3, mBuyLinePaint!..style = PaintingStyle.fill);
      canvas.drawCircle(Offset(dx, dy), radius, mBuyLinePaint!..style = PaintingStyle.stroke);
    } else {
      canvas.drawCircle(Offset(dx, dy), radius / 3, mSellLinePaint!..style = PaintingStyle.fill);
      canvas.drawCircle(Offset(dx, dy), radius, mSellLinePaint!..style = PaintingStyle.stroke);
    }
